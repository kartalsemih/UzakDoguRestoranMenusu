...
button1.type = "button";
button1.classList.add("btn", "btn-outline-dark");
...
button2.type = "button";
button2.classList.add("btn", "btn-outline-dark");
...
button3.type = "button";
button3.classList.add("btn", "btn-outline-dark");
...
button4.type = "button";
button4.classList.add("btn", "btn-outline-dark");
...
let butonlar = document.querySelectorAll(".btn-outline-dark");
for(let i=0;i<butonlar.length;i++){
  butonlar[i].style.marginRight="10px";
}
